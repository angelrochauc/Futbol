...
<body>
    ...
    <nav class="bc navbar navbar-dark navbar-expand-md sticky-top">
        <div class="container ">
            ...
            <div><h3 style="color: #ffffff;">Estad&iacute;sticas Jugadores</h3></div>
    ...
    <div id="seleccionarTorneo" name="seleccionarTorneo">
        <?php comboTorneo('Todos los Torneos'); ?>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="fAddForm" class="needs-validation" autocomplete="off">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="goles" name="goles" required oninvalid="this.setCustomValidity('Cantidad de goles es requerido')">
                            <label for="goles">Numero de Goles</label>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="modalEliminar">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Eliminar Goles para el Jugador</h5>
...
<script type="text/javascript">
    ...
    function agregarGoles() {
        ...
        Titulo.textContent = 'Ingresar Goles Para el Jugador';
        modalJugador.show();
        $("#NuevoRegistro").val('1');
    };

    function editarGoles(JugadorId) {
        var Titulo = $('#modalJugador')[0].querySelector('.modal-title');
    ...
    function eliminarGoles(JugadorId) {
        modalEliminar.show();
    ...
    function guardar() {
        ...
        $.ajax({
            ...
            success: function(r) {
                $('#respuesta').html(r);
                notification('Goles para el Jugador Guardados', 'success');
            }
        });
        $('#fAddForm')[0].reset();
        modalJugador.hide();
