...
<body>
    ...
    <nav class="bc navbar navbar-dark navbar-expand-md sticky-top">
        <div class="container ">
            ...
            <div><h3 style="color: #ffffff;">Menu</h3></div>
    ...
    <div class="container-fluid text-center mt-5">
        <div class="mt-5">
            <div class="row mt-5">
                ...
                <div class="col">
                    <button class="bt">
                        <a href="forms/f_jugador.php">
                            <img src="img/jugador.png" title="Jugadores">
                        </a></button>
                </div>

                <div class="col">
                    <button class="bt">
                        <a href="forms/f_equipo.php">
                            <img src="img/equipo.png" title="Equipos">
                        </a></button>
                </div>

                <div class="col">
                    <button class="bt">
                        <a href="forms/f_cancha.php">
                            <img src="img/cancha.png" title="Canchas">
                        </a></button>
                </div>
            ...
            <div class="row mt-5">
                ...
                <div class="col">
                    <button class="bt">
                        <a href="forms/f_torneo.php">
                            <img src="img/torneo.png" title="Torneos">
                        </a></button>
                </div>

                <div class="col">
                    <button class="bt">
                        <a href="menuStats.php">
                            <img src="img/stats.png" title="Estadisticas">
                        </a></button>
                </div>
                <?php
                if ($_SESSION['Perfil'] == 'admin') {
                    echo '<div class="col"><button class="bt"><a href="forms/f_usuario.php"><img src="img/usuario.png" title="Usuarios"></a></button></div>';
                }
                ?>
                <div class="col"></div>
            </div>
